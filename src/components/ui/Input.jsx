  ...
  return (
    <div className={`flex flex-col gap-[6px] ${fullWidth ? 'w-full' : ''}`}>
      ...
      <div className="relative flex items-center">
        {iconLeft && (
          <div className="absolute left-[16px] inset-y-0 text-[var(--color-neutral-4)] flex items-center justify-center pointer-events-none transition-colors group-focus-within:text-[var(--color-brand-500)]">
        ...
        <input
          ...
          className={`
            ...
            ${error
              ...
              : 'border-[var(--color-border-color-border)] focus:border-[2px] focus:border-[var(--color-brand-500)] focus:ring-2 focus:ring-[var(--color-brand-300)]'}
        ...
        {iconRight && (
          <div className="absolute right-[16px] inset-y-0 text-[var(--color-neutral-4)] flex items-center justify-center cursor-pointer transition-colors hover:text-[var(--color-neutral-6)]">
