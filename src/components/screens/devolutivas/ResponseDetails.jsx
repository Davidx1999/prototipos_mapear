...
export default function ResponseDetails({
  ...
  const textColor1 = chipBg1 === '#FFFFFF' ? '#0F1113' : (isMonochromatic ? '#0F1113' : (chipBg1 === '#004488' || chipBg1 === '#BB5566' || chipBg1 === '#F45F74' || chipBg1 === '#E35759' || chipBg1 === '#0B81A2' || chipBg1 === '#36B802' || chipBg1 === '#0D7E87' || chipBg1 === '#FF5A5D' || chipBg1 === '#6B8E23' || chipBg1 === '#C74A3A' || chipBg1 === '#5E4B4E' ? '#FFFFFF' : '#0F1113'));
  ...
  if (chipBg2 === '#FFFFFF') {
    ...
    const isDarkBg2 = chipBg2 === '#004488' || chipBg2 === '#BB5566' || chipBg2 === '#F45F74' || chipBg2 === '#E35759' || chipBg2 === '#0B81A2' || chipBg2 === '#36B802' || chipBg2 === '#0D7E87' || chipBg2 === '#FF5A5D' || chipBg2 === '#6B8E23' || chipBg2 === '#C74A3A' || chipBg2 === '#5E4B4E';
