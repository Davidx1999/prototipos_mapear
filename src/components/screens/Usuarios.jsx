  ...
  return (
    <main className="flex-1 w-full max-w-[1440px] mx-auto px-[16px] md:px-[32px] py-[24px] md:py-[32px] animate-fade-slide flex flex-col h-full bg-white">
      <div className="flex items-center gap-[8px] mb-[16px] md:mb-[24px] overflow-x-auto hide-scrollbar whitespace-nowrap">
        ...
        <span className="text-[13px] md:text-[14px] font-medium shrink-0" style={{ color: colors.neutral[4] }}>/ Gerenciamento de Usuários</span>
      </div>
                ...
                {expandedUser === u.id && (
                  <div className="px-[48px] sm:px-[64px] py-[16px] md:py-[24px] border-b bg-[#FDFDFD]" style={{ borderColor: colors.neutral[2] }}>
                    ...
                    <div className="flex items-center gap-[12px] md:gap-[16px] mb-[16px] flex-wrap">
                      <span className="text-[12px] md:text-[13px] font-bold" style={{ color: colors.neutral[7] }}>Legenda:</span>
                    ...
                    <div className="flex items-center gap-[12px] md:gap-[16px] flex-wrap">
                      <span className="flex items-center gap-[8px] text-[12px] md:text-[13px] font-bold" style={{ color: colors.neutral[5] }}><UsersIcon size={16}/> Turmas</span>
