      ...
      <div className="sticky top-[64px] md:top-[74px] z-40 bg-neutral-0 pt-[8px] pb-[8px] -mx-[16px] md:-mx-[32px] px-[16px] md:px-[32px] mb-[24px]">
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b gap-[16px] md:gap-0" style={{ borderColor: colors.neutral[2] }}>
          <div className="flex items-center overflow-x-auto hide-scrollbar w-full">
            <div className={`px-[16px] md:px-[24px] py-[12px] font-bold text-[13px] md:text-[14px] cursor-pointer whitespace-nowrap border-b-2 transition-colors ${acompanhamentoTab === 0 ? 'border-primary-base text-primary-base' : 'border-transparent text-neutral-5 hover:text-primary-base'}`} onClick={() => setAcompanhamentoTab(0)}>
              Teoria Clássica dos Testes (TCT)
            </div>
            <div className={`px-[16px] md:px-[24px] py-[12px] font-bold text-[13px] md:text-[14px] cursor-pointer whitespace-nowrap border-b-2 transition-colors ${acompanhamentoTab === 1 ? 'border-primary-base text-primary-base' : 'border-transparent text-neutral-5 hover:text-primary-base'}`} onClick={() => setAcompanhamentoTab(1)}>
              Teoria de Resposta ao Item (TRI)
            </div>
            <div className={`px-[16px] md:px-[24px] py-[12px] font-bold text-[13px] md:text-[14px] cursor-pointer whitespace-nowrap border-b-2 transition-colors ${acompanhamentoTab === 2 ? 'border-primary-base text-primary-base' : 'border-transparent text-neutral-5 hover:text-primary-base'}`} onClick={() => setAcompanhamentoTab(2)}>
              Linha do Tempo
            </div>
          </div>
             ...
             <div className="lg:col-span-2 bg-neutral-0 rounded-[8px] border shadow-sm flex flex-col" style={{ borderColor: colors.neutral[2] }}>
               ...
               <div className="p-[16px] border-t bg-[#FDFDFD] flex flex-col sm:flex-row justify-between items-center gap-[16px]" style={{ borderColor: colors.neutral[2] }}>
                 ...
                 <div className="flex items-center gap-[12px]">
                   ...
                   <span className="text-[13px] font-bold cursor-pointer flex items-center gap-[4px] px-[12px] py-[6px] rounded-[4px] border bg-neutral-0" style={{ borderColor: colors.neutral[3] }}>Turma <ChevronDown size={14}/></span>
                 </div>
               </div>
             </div>
             ...
             <div className="bg-neutral-0 rounded-[8px] border shadow-sm flex flex-col" style={{ borderColor: colors.neutral[2] }}>
               ...
               <div className="p-[20px] flex flex-col gap-[24px]">
                  ...
                  <div className="flex flex-col gap-[8px]">
                    <div className="flex justify-between items-center"><span className="text-[13px] font-medium" style={{ color: colors.neutral[6] }}>Reconhecer</span><BarChart size={14} className="text-primary-base"/></div>
                    <div className="flex items-center gap-[12px]">
                  ...
                  <div className="flex flex-col gap-[8px]">
                    <div className="flex justify-between items-center"><span className="text-[13px] font-medium" style={{ color: colors.neutral[6] }}>Aplicar</span><BarChart size={14} className="text-primary-base"/></div>
                    <div className="flex items-center gap-[12px]">
                  ...
                  <div className="flex flex-col gap-[8px]">
                    <div className="flex justify-between items-center"><span className="text-[13px] font-medium" style={{ color: colors.neutral[6] }}>Raciocinar</span><BarChart size={14} className="text-primary-base"/></div>
                    <div className="flex items-center gap-[12px]">
                  ...
                  <div className="flex flex-col gap-[8px]">
                    <div className="flex justify-between items-center"><span className="text-[13px] font-medium" style={{ color: colors.neutral[6] }}>Interpretar</span><BarChart size={14} className="text-primary-base"/></div>
                    <div className="flex items-center gap-[12px]">
                      ...
                      <div className={`flex flex-col gap-[16px] w-full md:max-w-[360px]`}>
                         {monthData.items.map((item, itemIdx) => (
                            <div key={itemIdx} className="w-full">
                              {item.type === 'text' && (
                                <div className="bg-neutral-0 border rounded-[8px] p-[12px] shadow-sm text-[13px] font-bold text-neutral-6" style={{ borderColor: colors.neutral[2] }}>
                                  {item.content}
                                </div>
                              )}
                              {item.type === 'card' && (
