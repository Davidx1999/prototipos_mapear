...
const Acompanhamento = ({ 
  ...
  return (
    <main className="flex-1 w-full max-w-[1440px] mx-auto px-[16px] md:px-[32px] py-[24px] md:py-[32px] animate-fade-slide flex flex-col h-full bg-[#F7F8FA]">
      <div className="flex items-center gap-[8px] mb-[16px] md:mb-[24px] overflow-x-auto hide-scrollbar whitespace-nowrap">
        ...
        <span className="text-[13px] md:text-[14px] font-medium shrink-0" style={{ color: colors.neutral[4] }}>/ Acompanhamento Escolar</span>
      </div>

      <h2 className="text-[22px] md:text-[28px] font-bold mb-[8px]" style={{ color: colors.neutral[7] }}>Acompanhamento Escolar</h2>
      <p className="text-[13px] md:text-[14px] mb-[24px] md:mb-[32px]" style={{ color: colors.neutral[5] }}>Para começar, selecione o acompanhamento de notas que deseja realizar entre Alunos ou Escolas.</p>
      ...
      <div className="flex flex-col mb-[32px] gap-[12px]">
        ...
        <div className="flex items-center gap-[8px] overflow-x-auto hide-scrollbar bg-white border p-[8px] rounded-[12px] shadow-sm" style={{ borderColor: colors.neutral[2] }}>
          ...
          <div className="flex items-center gap-[8px] px-[8px] border-r" style={{ borderColor: colors.neutral[2] }}>
            <span className="text-[13px] font-semibold whitespace-nowrap" style={{ color: colors.neutral[7] }}>Fortaleza</span>
            <ChevronRight size={14} style={{ color: colors.neutral[4] }}/>
          </div>
          <div className="flex items-center gap-[8px] px-[8px] border-r" style={{ borderColor: colors.neutral[2] }}>
            <span className="text-[13px] font-semibold whitespace-nowrap" style={{ color: colors.neutral[7] }}>Liceu do Conjunto Ceará</span>
            <ChevronRight size={14} style={{ color: colors.neutral[4] }}/>
          </div>
          <div className="flex items-center gap-[8px] px-[8px] border-r" style={{ borderColor: colors.neutral[2] }}>
            <span className="text-[13px] font-semibold whitespace-nowrap" style={{ color: colors.neutral[7] }}>2025</span>
            <ChevronRight size={14} style={{ color: colors.neutral[4] }}/>
          </div>
          <div className="flex items-center gap-[8px] px-[8px] border-r" style={{ borderColor: colors.neutral[2] }}>
            <span className="text-[13px] font-semibold whitespace-nowrap" style={{ color: colors.neutral[7] }}>Turma B</span>
            <ChevronRight size={14} style={{ color: colors.neutral[4] }}/>
          </div>
          <div className="flex items-center gap-[8px] px-[16px] min-w-[200px]">
            <select className="w-full bg-transparent outline-none text-[13px] font-bold appearance-none cursor-pointer" style={{ color: colors.neutral[7] }}>
          ...
          <div className="ml-auto flex items-center gap-[8px] shrink-0 pl-[16px]">
             ...
             <Button variant="tertiary" size="sm" className="bg-white"><Search size={14} className="mr-[4px]"/> PESQUISA RÁPIDA</Button>
      ...
      <div className="mb-[32px]">
        ...
        <p className="text-[13px] mt-[4px] flex items-center gap-[8px]" style={{ color: colors.neutral[5] }}>
      ...
      <div className="sticky top-[64px] md:top-[74px] z-40 bg-[#F7F8FA] pt-[8px] pb-[8px] -mx-[16px] md:-mx-[32px] px-[16px] md:px-[32px] mb-[24px]">
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b gap-[16px] md:gap-0" style={{ borderColor: colors.neutral[2] }}>
          <div className="flex items-center overflow-x-auto hide-scrollbar w-full">
            <div className={`px-[16px] md:px-[24px] py-[12px] font-bold text-[13px] md:text-[14px] cursor-pointer whitespace-nowrap border-b-2 transition-colors ${acompanhamentoTab === 0 ? 'border-[#008BC9] text-[#008BC9]' : 'border-transparent text-[#677080] hover:text-[#008BC9]'}`} onClick={() => setAcompanhamentoTab(0)}>
              Teoria Clássica dos Testes (TCT)
            </div>
            <div className={`px-[16px] md:px-[24px] py-[12px] font-bold text-[13px] md:text-[14px] cursor-pointer whitespace-nowrap border-b-2 transition-colors ${acompanhamentoTab === 1 ? 'border-[#008BC9] text-[#008BC9]' : 'border-transparent text-[#677080] hover:text-[#008BC9]'}`} onClick={() => setAcompanhamentoTab(1)}>
              Teoria de Resposta ao Item (TRI)
            </div>
            <div className={`px-[16px] md:px-[24px] py-[12px] font-bold text-[13px] md:text-[14px] cursor-pointer whitespace-nowrap border-b-2 transition-colors ${acompanhamentoTab === 2 ? 'border-[#008BC9] text-[#008BC9]' : 'border-transparent text-[#677080] hover:text-[#008BC9]'}`} onClick={() => setAcompanhamentoTab(2)}>
              Linha do Tempo
            </div>
          </div>
          <div className="shrink-0 pb-[8px] md:pb-0 flex justify-end w-full md:w-auto">
             <Button variant="tertiary" size="sm" className="bg-white"><FileText size={16}/> Exportar para PDF</Button>
          </div>
        </div>
      </div>
        ...
        <div className="animate-fade-slide">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-[24px] gap-[16px]">
            <div>
              ...
              <div className="flex items-center gap-[8px] overflow-x-auto hide-scrollbar">
                 {['Todos os anos', '2023', '2024', '2025', '2026', '2027', '2028', '2029'].map(year => (
                   <div key={year} className={`px-[12px] py-[4px] rounded-full text-[12px] font-bold cursor-pointer transition-colors ${year === '2023' ? 'bg-[#94CFEF] text-[#003A79]' : 'bg-transparent text-[#008BC9] hover:bg-[#D9F0FC]'}`}>{year}</div>
                 ))}
              </div>
            </div>
            <div className="shrink-0">
              ...
              <div className="flex items-center bg-[#E5E7EB] rounded-full p-[2px]">
                 <div className="px-[16px] py-[4px] rounded-full text-[12px] font-bold cursor-pointer text-[#677080] hover:text-[#1D2432]">Repertório</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-[16px] mb-[24px]">
             <div className="lg:col-span-2 bg-white rounded-[12px] border shadow-sm flex flex-col" style={{ borderColor: colors.neutral[2] }}>
               <div className="p-[20px] border-b flex justify-between items-center" style={{ borderColor: colors.neutral[2] }}>
                 ...
                 <div className="flex items-center gap-[8px]">
                   ...
                   <span className="text-[13px] font-bold cursor-pointer flex items-center gap-[4px]" style={{ color: colors.primary.base }}>Semestre <ChevronDown size={14}/></span>
               ...
               <div className="p-[24px] flex-1 flex flex-col items-center justify-center relative min-h-[300px]">
                  <div className="flex gap-[24px] mb-[32px]">
                    <div className="flex items-center gap-[8px]"><div className="w-[12px] h-[4px] rounded-full bg-[#A855F7]"></div><span className="text-[13px] font-bold text-[#A855F7]">Leitura</span></div>
                    <div className="flex items-center gap-[8px]"><div className="w-[12px] h-[4px] rounded-full bg-[#F59E0B]"></div><span className="text-[13px] font-bold text-[#F59E0B]">Matemática</span></div>
                  </div>
             ...
             <div className="bg-white rounded-[12px] border shadow-sm flex flex-col" style={{ borderColor: colors.neutral[2] }}>
               ...
               <div className="p-[20px] flex flex-col gap-[24px]">
                  <span className="text-[13px] font-bold" style={{ color: colors.neutral[7] }}>Matemática</span>
                  
                  <div className="flex flex-col gap-[8px]">
                    <div className="flex justify-between items-center"><span className="text-[13px] font-medium" style={{ color: colors.neutral[6] }}>Reconhecer</span><BarChart size={14} className="text-[#008BC9]"/></div>
                    <div className="flex items-center gap-[12px]">
                  ...
                  <div className="flex flex-col gap-[8px]">
                    <div className="flex justify-between items-center"><span className="text-[13px] font-medium" style={{ color: colors.neutral[6] }}>Aplicar</span><BarChart size={14} className="text-[#008BC9]"/></div>
                    <div className="flex items-center gap-[12px]">
                      <div className="flex-1 h-[8px] bg-[#E5E7EB] rounded-full overflow-hidden"><div className="h-full bg-[#4ADE80]" style={{ width: '83%' }}></div></div>
                      <span className="text-[13px] font-bold">83%</span>
                    </div>
                  </div>
                  <div className="flex flex-col gap-[8px]">
                    <div className="flex justify-between items-center"><span className="text-[13px] font-medium" style={{ color: colors.neutral[6] }}>Raciocinar</span><BarChart size={14} className="text-[#008BC9]"/></div>
                    <div className="flex items-center gap-[12px]">
                      <div className="flex-1 h-[8px] bg-[#E5E7EB] rounded-full overflow-hidden"><div className="h-full bg-[#4ADE80]" style={{ width: '87%' }}></div></div>
                      <span className="text-[13px] font-bold">87%</span>
                    </div>
                  </div>
                  <div className="flex flex-col gap-[8px]">
                    <div className="flex justify-between items-center"><span className="text-[13px] font-medium" style={{ color: colors.neutral[6] }}>Interpretar</span><BarChart size={14} className="text-[#008BC9]"/></div>
                    <div className="flex items-center gap-[12px]">
                      <div className="flex-1 h-[8px] bg-[#E5E7EB] rounded-full overflow-hidden"><div className="h-full bg-[#9CA3AF]" style={{ width: '47%' }}></div></div>
                      <span className="text-[13px] font-bold">47%</span>
                    </div>
                  </div>
               </div>
             </div>
          ...
          <div className="bg-white rounded-[12px] border shadow-sm mb-[32px]" style={{ borderColor: colors.neutral[2] }}>
             <div className="p-[20px] border-b flex justify-between items-center" style={{ borderColor: colors.neutral[2] }}>
               ...
               <div className="flex items-center gap-[8px]">
                 <BarChart2 size={16} className="text-[#008BC9]"/>
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x" style={{ borderColor: colors.neutral[2] }}>
               <div className="p-[24px]">
                 <span className="text-[13px] font-bold mb-[24px] block" style={{ color: colors.neutral[6] }}>Percentual de Acerto</span>
                 <div className="h-[250px] flex items-end justify-between px-[16px] relative">
                   ...
                   <div className="flex items-end justify-between w-full h-full pl-[24px] pb-[24px]">
                     <div className="w-[12%] bg-[#FACC15] rounded-t-[4px] relative group" style={{ height: '42%' }}><span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T4</span></div>
                     <div className="w-[12%] bg-[#4ADE80] rounded-t-[4px] relative" style={{ height: '75%' }}><span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T5</span></div>
                     <div className="w-[12%] bg-[#4ADE80] rounded-t-[4px] relative" style={{ height: '100%' }}><span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T6</span></div>
                     ...
                     <div className="w-[12%] bg-[#4ADE80] rounded-t-[4px] relative" style={{ height: '92%' }}><span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T8</span></div>
                     <div className="w-[12%] bg-[#4ADE80] rounded-t-[4px] relative" style={{ height: '95%' }}><span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T9</span></div>
                   </div>
                 </div>
               ...
               <div className="p-[24px]">
                 <span className="text-[13px] font-bold mb-[24px] block" style={{ color: colors.neutral[6] }}>Distribuição de Conceito</span>
                 <div className="h-[250px] flex items-end justify-between px-[16px] relative">
                   <div className="absolute inset-0 flex flex-col justify-between text-[11px] text-[#969DA9] pointer-events-none pb-[24px]">
                     <span>100</span><span>75</span><span>50</span><span>25</span><span>0</span>
                   </div>
                   <div className="flex items-end justify-between w-full h-full pl-[24px] pb-[24px]">
                     <div className="w-[12%] h-full flex flex-col justify-end relative">
                       ...
                       <div className="w-full bg-white border border-[#DEE1E8]" style={{ height: '6%' }}></div>
                       <span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T4</span>
                     </div>
                     <div className="w-[12%] h-full flex flex-col justify-end relative">
                       ...
                       <div className="w-full bg-white border border-[#DEE1E8]" style={{ height: '4%' }}></div>
                       <span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T5</span>
                     </div>
                     <div className="w-[12%] h-full flex flex-col justify-end relative">
                       ...
                       <span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T6</span>
                     </div>
                     ...
                     <div className="w-[12%] h-full flex flex-col justify-end relative">
                       ...
                       <span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T8</span>
                     </div>
                     <div className="w-[12%] h-full flex flex-col justify-end relative">
                       <div className="w-full bg-[#4ADE80] rounded-t-[4px]" style={{ height: '82%' }}></div>
                       <div className="w-full bg-[#FACC15]" style={{ height: '11%' }}></div>
                       <div className="w-full bg-[#EF4444]" style={{ height: '7%' }}></div>
                       <span className="absolute -bottom-[20px] text-[11px] font-bold text-[#008BC9] w-full text-center">T9</span>
                     </div>
                   </div>
                 </div>
                 <div className="flex justify-between px-[48px] mt-[8px] text-[11px] font-medium" style={{ color: colors.neutral[5] }}>
      ...
      {acompanhamentoTab === 2 && (
        <div className="animate-fade-slide flex flex-col items-center py-[24px]">
           <div className="flex items-center gap-[40px] mb-[24px]">
              <span className="text-[18px] font-bold text-[#969DA9] cursor-pointer hover:text-[#008BC9]">2022</span>
              <span className="text-[18px] font-bold text-[#969DA9] cursor-pointer hover:text-[#008BC9]">2023</span>
              <span className="text-[18px] font-bold text-[#969DA9] cursor-pointer hover:text-[#008BC9]">2024</span>
              <div className="flex flex-col items-center">
                <span className="text-[28px] font-black text-[#1D2432]">2025</span>
           ...
           <div className="flex items-center gap-[16px] md:gap-[24px] mb-[48px] overflow-x-auto hide-scrollbar w-full justify-center">
             <span className="text-[12px] font-bold text-[#008BC9] flex items-center gap-[4px] cursor-pointer border-b border-[#008BC9] pb-[4px]">Jan <ChevronDown size={14}/></span>
             {['Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago', 'Set', 'Out', 'Nov', 'Dez'].map(m => (
               <span key={m} className="text-[12px] font-bold text-[#969DA9] cursor-pointer hover:text-[#008BC9] pb-[4px] border-b border-transparent">{m}</span>
             ))}
               ...
               return (
                 <div key={idx} className={`relative flex w-full mb-[48px] flex-col md:flex-row ${isLeft ? 'md:flex-row-reverse' : ''} items-start`}>
                   ...
                   <div className={`w-full pl-[56px] md:pl-0 md:w-1/2 flex flex-col ${isLeft ? 'md:pr-[40px] md:items-end' : 'md:pl-[40px] md:items-start'}`}>
                      <div className="text-[14px] font-bold text-[#008BC9] mb-[16px]">{monthData.month}</div>
                      ...
                      <div className={`flex flex-col gap-[16px] w-full md:max-w-[360px]`}>
                         {monthData.items.map((item, itemIdx) => (
                            <div key={itemIdx} className="w-full">
                              {item.type === 'text' && (
                                <div className="bg-white border rounded-[8px] p-[12px] shadow-sm text-[13px] font-bold text-[#1D2432]" style={{ borderColor: colors.neutral[2] }}>
                                  {item.content}
                                </div>
                              )}
                              {item.type === 'card' && (
                                <div className="bg-white border rounded-[12px] p-[20px] shadow-sm w-full" style={{ borderColor: colors.neutral[2] }}>
                                  ...
                                  <h4 className="text-[14px] font-bold text-[#1D2432] mb-[24px] leading-tight text-left">{item.title}</h4>
                                  ...
                                  <div className="flex justify-end text-[11px] font-bold text-[#677080]">{item.rank}</div>
                                </div>
                              )}
                            </div>
                         ))}
