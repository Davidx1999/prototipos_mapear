          ...
          {expandedItem === m.cod && (
            <div className="px-[24px] md:px-[64px] py-[24px] border-b bg-[#FDFDFD]" style={{ borderColor: colors.neutral[2] }}>
              ...
              <div className="flex flex-col gap-[12px] bg-neutral-0 p-[16px] rounded-[8px] border mb-[16px]" style={{ borderColor: colors.neutral[2] }}>
                <div className="flex items-center gap-[8px] text-[13px]"><BookOpen size={16} className="text-primary-base shrink-0"/> <strong className="shrink-0">Ano(s) Escolar(es):</strong> <span className="truncate">6º Ano, 7º Ano, 8º Ano</span></div>
                <div className="flex items-center gap-[8px] text-[13px]"><GitCompare size={16} className="text-[#10B981] shrink-0"/> <strong className="shrink-0">Equivalência(s):</strong> <span className="truncate">BNCC ({m.cod}), SAEB (P0{Math.floor(Math.random() * 9) + 1})</span></div>
                <div className="flex items-center gap-[8px] text-[13px] flex-wrap">
