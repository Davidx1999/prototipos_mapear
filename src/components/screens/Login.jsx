...
const Login = ({
  ...
  return (
    <div className="min-h-screen w-full flex p-[16px] md:p-[24px]" style={{ backgroundColor: isHighContrast ? '#000000' : colors.neutral[0], fontFamily: 'Montserrat, sans-serif' }}>
      <div className="w-full relative flex items-center justify-center rounded-[16px] md:rounded-[24px] overflow-hidden transition-all duration-500" style={{ backgroundColor: isHighContrast ? '#000000' : colors.primary.base, border: isHighContrast ? '2px solid #FACC15' : 'none', backgroundImage: isHighContrast ? 'none' : 'url("https://images.unsplash.com/photo-1619252584172-a83a949b6efd?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundBlendMode: 'multiply' }}>
        <div className="relative z-10 p-[32px] md:p-[48px] rounded-[16px] w-full max-w-[420px] shadow-2xl flex flex-col items-center transition-colors duration-500 m-[16px]" style={{ backgroundColor: colors.neutral[0], border: isHighContrast ? '1px solid #FFFFFF' : 'none' }}>
