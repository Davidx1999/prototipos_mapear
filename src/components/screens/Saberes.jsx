      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-[16px] md:px-[32px] py-[24px] md:py-[32px] animate-fade-slide flex flex-col h-full bg-neutral-0">
        ...
        <div className="bg-neutral-0 rounded-[8px] border overflow-hidden flex-1 shadow-sm mb-[24px]" style={{ borderColor: colors.neutral[2] }}>
          <div className="w-full">
            ...
            <div className="grid grid-cols-[1fr_40px] md:grid-cols-[1fr_1fr_60px] gap-[16px] px-[16px] sm:px-[24px] py-[12px] border-b text-[13px] md:text-[14px] text-neutral-6 items-center">
            ...
            <div className="grid grid-cols-[1fr_40px] md:grid-cols-[1fr_1fr_60px] gap-[16px] px-[16px] sm:px-[24px] py-[12px] text-[13px] md:text-[14px] text-neutral-6 items-center">
          ...
          <div className="flex flex-col md:flex-row justify-between md:items-center gap-[12px]">
            ...
            {activeSaberesTab > 0 && (
              <div className="flex gap-[8px] overflow-x-auto hide-scrollbar w-full md:w-auto justify-start md:justify-end pb-[2px]">
                ...
                {activeSaberesTab === 5 && (
                  <>
                    <div className="flex items-center gap-[8px] px-[12px] py-[6px] rounded-[8px] border cursor-pointer bg-neutral-0 text-[12px] font-semibold hover:bg-neutral-1 whitespace-nowrap shrink-0" style={{ borderColor: colors.neutral[3], color: colors.neutral[6] }}><Filter size={14} /> Dom. Cognitivo <ChevronDown size={14} /></div>
                    <div className="flex items-center gap-[8px] px-[12px] py-[6px] rounded-[8px] border cursor-pointer bg-neutral-0 text-[12px] font-semibold hover:bg-neutral-1 whitespace-nowrap shrink-0" style={{ borderColor: colors.neutral[3], color: colors.neutral[6] }}><Filter size={14} /> Conhecimento <ChevronDown size={14} /></div>
                  </>
                )}
              </div>
            )}
        ...
        {activeSaberesTab === 6 && (
          <div className="flex gap-[16px] w-full flex-col md:flex-row">
            <div className="flex-1 flex flex-col gap-[8px]">
              ...
              <select className="w-full px-[16px] py-[10px] rounded-[8px] border text-[13px] outline-none bg-neutral-0"><option>Selecione</option></select>
            </div>
            <div className="flex-1 flex flex-col gap-[8px]">
                ...
                {expandedItem === m.cod && (
                  <div className="px-[24px] md:px-[64px] py-[24px] border-b bg-[#FDFDFD]" style={{ borderColor: colors.neutral[2] }}>
                    ...
                    <div className="flex flex-col gap-[12px] bg-neutral-0 p-[16px] rounded-[8px] border mb-[16px]" style={{ borderColor: colors.neutral[2] }}>
                      <div className="flex items-center gap-[8px] text-[13px]"><BookOpen size={16} className="text-primary-base shrink-0"/> <strong className="shrink-0">Ano(s) Escolar(es):</strong> <span className="truncate">3º Ano, 4º Ano</span></div>
