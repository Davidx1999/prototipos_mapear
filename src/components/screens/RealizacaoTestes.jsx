...
export default function RealizacaoTestes({ colors, isDarkMode, navigateTo }) {
  ...
  // ==========================================================================
  if (currentScreen === 'dashboard') { return <Dashboard colors={colors} mockAssessments={mockAssessments} dashboardTab={dashboardTab} setDashboardTab={setDashboardTab} setSelectedAssessmentId={setSelectedAssessmentId} setCurrentScreen={setCurrentScreen} searchQuery={searchQuery} setSearchQuery={setSearchQuery} />; }
