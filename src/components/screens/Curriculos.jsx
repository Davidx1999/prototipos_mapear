          ...
          <div className="w-full">
            ...
            {mockDominios.map((m) => (
              <React.Fragment key={m.cod}>
                <div className="flex items-center gap-[8px] sm:gap-[16px] px-[16px] sm:px-[24px] py-[12px] border-b text-[14px] md:text-[14px] text-neutral-6">
                ...
                {expandedItem === m.cod && (
                  <div className="px-[48px] sm:px-[64px] py-[16px] border-b bg-[#FDFDFD]" style={{ borderColor: colors.neutral[2] }}>
                    ...
                    <div className="md:hidden flex flex-col gap-[8px] text-[14px] text-neutral-5">
